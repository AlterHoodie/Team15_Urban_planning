import math
import itertools
from ReinforcementLearning.utils.logger import StatsLogger
...
class LoggerRL:
    ...
    def __init__(self, init_stats_logger=True):
        ...
        self.num_episodes = 0
        self.sample_time = 0
        self.stats_names = ['episode_len', 'reward', 'episode_reward', 'road_network', 'life_circle', 'greenness','wastemgmt']
    ...
    def end_episode(self, info):
        ...
        self.stats_loggers['wastemgmt'].log(info['wastemgmt'])
    ...
    def merge(cls, logger_list, **kwargs):
        ...
        logger.avg_episode_wastemgmt_reward = logger.stats_loggers['wastemgmt'].avg()
        # logger.avg_episode_drainage_reward = logger.stats_loggers['drainage'].avg()
